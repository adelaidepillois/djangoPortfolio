!function (t, e) {
                ...
                key: "updateElements", value: function () {
                    ...
                    Object.entries(this.els).forEach((function (e) {
                        var i = f(e, 2), s = i[0], n = i[1],
                            ...
                            l = o + n.targetEl.offsetHeight, r = t.getRelativeOffset(n.offset);
    ...
    var tt = function (t, e, i, s) {
        ...
        function l(e) {
            ...
            --o;
            var l = s + .1 * ((e - n[o]) / (n[o + 1] - n[o])), r = Q(l, t, i);
    ...
    }, et = 38, it = 40, st = 32, nt = 9, ot = 33, lt = 34, rt = 36, at = 35, ct = function (e) {
        l(n, e);
        var s = d(n);
        ...
        return i(n, [{
            ...
            key: "isActiveElementScrollSensitive", value: function () {
            ...
            key: "addElements", value: function () {
                ...
                this.els = {}, this.parallaxElements = {}, this.el.querySelectorAll("[data-".concat(this.name, "]")).forEach((function (e, i) {
                    ...
                    var S = s + o.offsetHeight, x = n + o.offsetWidth, k = {x: (x - n) / 2 + n, y: (S - s) / 2 + s};
                    if (v) {
            ...
            key: "scrollTo", value: function (t) {
                var e = this, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                    ...
                    o = i.easing || [.25, 0, .35, 1], l = !!i.disableLerp, r = !!i.callback && i.callback;
